        ...
        <div className="p-6 min-h-[400px] flex flex-col items-center justify-center">
            {isGenerating ? (
                ...
                <div className="w-full">
                    <div className="mb-8 rounded-lg border border-primary/20 bg-primary/5 p-4 text-xs leading-relaxed text-muted-foreground">
                        <span className="font-bold text-foreground">DISCLAIMER:</span> Foundrie AI provides tools for educational and informational purposes only. Content generated by our tools does not constitute legal, financial, investment, or professional advice. Always verify important decisions with qualified professionals.
                    </div>
