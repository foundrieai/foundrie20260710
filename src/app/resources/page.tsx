    ...
    <main className="min-h-screen bg-[#08070c] text-white">
      <section className="container flex min-h-[calc(100svh-74px)] items-center py-24">
        <div className="max-w-3xl">
          <p className="font-code text-xs uppercase tracking-[0.24em] text-white/45">Resources</p>
          <h1 className="mt-5 text-5xl font-bold leading-tight tracking-normal text-white md:text-7xl">
            Founder, career, and brand intelligence is coming here.
          </h1>
          <p className="mt-6 text-lg leading-8 text-white/68">
            This section will house guides, playbooks, frameworks, and practical resources for building in the AI era of business.
          </p>
